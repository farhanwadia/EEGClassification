...
def runAllTrials(subject, savePath):
    trials = [[1, "Open (valve)"], [2, "Close (valve)"]]
    emojis = [[1, "🚰", "🚰"], [2, "🚱", "🚱"]]
    ...
    for r in range(numRepeats):
        ...
        for i, trial in enumerate(trials):
            ...
            showTrialWindow(description, leftEmoji, rightEmoji, color,2*r+i+1, EEGTime, EEGDelay, description, savePath, subject)
            #showRestWindow(random.randint(4,8))


# Change the subject and savePath
subject = "FW"
savePath = r"C:\Users\Farhan\Desktop\Covert Speech"
recorded_signal = []
connection = []
